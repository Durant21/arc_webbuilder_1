define({
  root: ({
    ...
    editableLayersSetting: "Editable layers settings",
    honorTheWebMapSetting: "Honor settings in the web map",
    honorTheWebMapSettingTip1: "These settings include:",
    honorTheWebMapSettingTip2: "Which layers are editable",
    honorTheWebMapSettingTip3: "The fields you want to display and edit",
    honorTheWebMapSettingTip4: "Alias, order, and format of a field",
