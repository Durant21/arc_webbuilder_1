    ...
    var Clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      ****************************************/
      ...
      _bindEventAfterOpen: function() {
        ...
        var handle = on(this._jimuLayerInfos, 'layerInfosChanged', lang.hitch(this, this._onLayerInfosChanged));
        this._releaseEventArrayAfterClose.push(handle);
        handle = on(this._jimuLayerInfos, 'layerInfosIsShowInMapChanged', lang.hitch(this, this._onLayerInfosChanged));
        this._releaseEventArrayAfterClose.push(handle);
